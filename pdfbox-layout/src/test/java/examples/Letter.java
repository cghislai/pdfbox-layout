...
public class Letter {
	...
	String arrowPath = "examples/arrow.png";
	ImageElement image  = new ImageElement(Letter.class.getClassLoader().getResourceAsStream(arrowPath));
	...
	final OutputStream outputStream = new FileOutputStream(args[0]+"letter.pdf");
