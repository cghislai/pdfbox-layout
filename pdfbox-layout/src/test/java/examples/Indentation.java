...
//	paragraph.addMarkup("Here we go indented.\n", 11, BaseFont.Times);
	...
	paragraph.add(new Indent("This is some label", 100, SpaceUnit.pt, 11,
		FontHelper.getFont(Standard14Fonts.FontName.TIMES_BOLD)));
	paragraph.addMarkup("Here we go indented.\n", 11, BaseFont.Times);
	paragraph
		.addMarkup(
	...
	paragraph.add(new Indent(new ArabicEnumerator().next() + " ", 4,
		SpaceUnit.em, 11, FontHelper.getFont(Standard14Fonts.FontName.TIMES_BOLD), Alignment.Right));
	...
	paragraph.add(new Indent(new LowerCaseRomanEnumerator().next() + " ",
		4, SpaceUnit.em, 11, FontHelper.getFont(Standard14Fonts.FontName.TIMES_BOLD), Alignment.Right));
	...
	paragraph.add(new Indent(new LowerCaseAlphabeticEnumerator().next()
		+ " ", 4, SpaceUnit.em, 11, FontHelper.getFont(Standard14Fonts.FontName.TIMES_BOLD),
		Alignment.Right));
	...
	final OutputStream outputStream = new FileOutputStream(args[0]+"indentation.pdf");
